...
public class PmsProductServiceImpl implements PmsProductService {
    ...
    @Override
    public int saveProduct(HzProduct hzProduct) {
        return hzProductMapper.insert(hzProduct);
    }

    @Override
    public List<HzProduct> selectProductList(Integer productUserId, Integer selectParam) {
        List<HzProduct> list = new ArrayList<HzProduct>();
        if(selectParam == 1){
             list = hzProductMapper.selectByIsUser(productUserId);
        }else {
             list = hzProductMapper.selectByIsNotUser(productUserId);
        }
        return list;
    }
