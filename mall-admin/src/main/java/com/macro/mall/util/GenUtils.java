...
public class GenUtils {
    ...
    public static void generatorCode(Map<String, String> table,
        ...
        for (String template : templates) {
            ...
            try {
                //添加到zip
                zip.putNextEntry(new ZipEntry(getFileName(tableDO.getTableName().split("_")[0],template, tableDO.getClassname(), Module,tableDO.getClassName(), packages.substring(packages.lastIndexOf(".") + 1))));
     ...
     * 获取文件名
     */
    public static String getFileName(String module,String template, String classname, String className, String Nodule, String packageName) {
